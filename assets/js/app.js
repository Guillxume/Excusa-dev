...
function pageLoading() {
	...
	if (httpCodeParam) {
		...
		if (message) {
			...
			// If there's no matching message, redirect to page lost
			window.history.pushState(null, null, "?page=lost");
			setTimeout(function () {
				window.location.href = window.location.origin + window.location.pathname;
			}, 5000);
			document.body.innerHTML = '<img src="https://media.giphy.com/media/njYrp176NQsHS/giphy.gif" alt="lost" style="display:block;margin:auto;">';
		}
	} else {
